<!DOCTYPE html>
  <html>
    ...
    <!-- Mulai Slder (Carausel) -->
    <div class="slider">
        <ul class="slides">
          <li>
            <img src="img/43924.jpg"> <!-- random image -->
            <div class="caption center-align">
              <h3>Cari Informasi Tagihan Sekolah ?</h3>
              <h5 class="text-lighten-3">Klik tombol MASUK di atas !</h5>
            </div>
          </li>
          <li>
            <img src="img/laptop.jpg"> <!-- random image -->
            <div class="caption center-align">
              <h3>Budayakan Tertib</h3>
              <h5 class="text-lighten-3">Tertib dengan membayar tepat waktu !</h5>
              <!-- perubahan warna tulisan .light grey-text  -->
            </div>
          </li>
        </ul>
    </div>
